...
export enum InterventionActionTypes {
  ...
  LoadInterventionsFail = '[Intervention] Load Interventions fail',
  LoadInterventionsInitiated = '[Intervention] Load Interventions initiate',
...
export class LoadInterventionsInitiated implements Action {
  readonly type = InterventionActionTypes.LoadInterventionsInitiated;
}

export class LoadInterventionsFail implements Action {
  readonly type = InterventionActionTypes.LoadInterventionsFail;
